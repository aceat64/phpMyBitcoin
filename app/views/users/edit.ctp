...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('View User', true), array('action' => 'view', $this->Form->value('User.id'))); ?></li>
		<li><?php echo $this->Html->link(__('Edit User', true), array('action' => 'edit', $this->Form->value('User.id'))); ?> </li>
